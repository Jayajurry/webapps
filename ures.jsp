                ...
                <div class="overlay all_overlay">
                    <div class="container">
                            ...
                            th{
                               ...
                               <div class="single_home_slider text-center">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                            <h4 style=" font-size:25px; margin-top:-100px; ">View EV Charging Reservation Status</h4>
                                            <br>
                     ...
                     %><table>
                         ...
                         PreparedStatement ps=con.prepareStatement("Select * from station1 where user='"+user+"' ");
