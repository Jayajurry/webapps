            ...
            <section id="home" class="home">
                <div class="overlay all_overlay">
                    <div class="container">
                     ...
                     %><form action="vstation.jsp">
                    <table align="center">
                        <tr><td><strong>Search By Location: </strong></td><td>
                            <select name="location" style="border-radius: 10px; height: 20px; width: 250px; height: 30px" required>
                                <option>Choose one</option>
                        <%
                        Class.forName("com.mysql.jdbc.Driver");
                        Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/evcharge","root","root");
                        PreparedStatement query=con.prepareStatement("select * from station group by location");
	            	...
	            	while(rs.next())
	            	{
                        ...
                        <tr><td align="center" colspan="2"><button type="submit" style="border-radius: 20px; height: 40px; width:80px;background-color:#f6c23a; ">Search</button></td></tr>
                    </table>
                    </form>								
