            ...
            <section id="home" class="home">
                <div class="overlay all_overlay">
                            ...
                            th{
                               ...
                               <div class="single_home_slider text-center">
                                        <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                            <h4 style=" font-size:25px; margin-top:-100px; ">View EV Charging Reservation Requests</h4>
                                            <br>
                    ...
                    <table>
                         ...
                         PreparedStatement ps=con.prepareStatement("Select * from station1  ");
                ...
                <td><%=cost%></td>
                 <td><%=contact%></td>
                 <td><%=location%></td>
                 <td ><a href="reqaction.jsp?user=<%=user%>&&sid=<%=sid%>" style=" color:  red;" ><%=status%></a></td>
                 </tr><%}%> 
